(function(){
  ...
  // ===== PARTS DATA =====
  // Ratchet（固鎖）：格式「面數-高度mm」，無英文字尾
  // Bit（攻軸）：純英文字
  var PARTS_DATA = {
    "gears": [
      // === 60mm 系列 ===
      {"id":"1-60","name":"1-60","sides":1,"height":60,"type":"攻擊","spin":"右","note":"最低高度，1個接觸點，撞擊爆擊"},
      {"id":"2-60","name":"2-60","sides":2,"height":60,"type":"持久","spin":"右","note":"2面接觸，低重心"},
      {"id":"3-60","name":"3-60","sides":3,"height":60,"type":"平衡","spin":"右","note":"3面接觸，泛用型"},
      {"id":"4-60","name":"4-60","sides":4,"height":60,"type":"防禦","spin":"右","note":"4面接觸，良好 Burst Resistance"},
      {"id":"5-60","name":"5-60","sides":5,"height":60,"type":"防禦","spin":"右","note":"5面接觸，偏重防禦"},
      {"id":"6-60","name":"6-60","sides":6,"height":60,"type":"持久","spin":"右","note":"6面對稱，高度穩定"},
      {"id":"7-60","name":"7-60","sides":7,"height":60,"type":"持久","spin":"右","note":"7面接觸，持久向"},
      {"id":"9-60","name":"9-60","sides":9,"height":60,"type":"持久","spin":"右","note":"9面，最高撞擊爆發力"},
      // === 70mm 系列 ===
      {"id":"2-70","name":"2-70","sides":2,"height":70,"type":"持久","spin":"左","note":"左手專用，2面接觸"},
      {"id":"3-70","name":"3-70","sides":3,"height":70,"type":"平衡","spin":"右","note":"3面70mm高"},
      {"id":"4-70","name":"4-70","sides":4,"height":70,"type":"防禦","spin":"左","note":"左手型，4面接觸"},
      {"id":"5-70","name":"5-70","sides":5,"height":70,"type":"防禦","spin":"右","note":"5面70mm高"},
      {"id":"7-70","name":"7-70","sides":7,"height":70,"type":"持久","spin":"右","note":"7面高身高"},
      {"id":"9-70","name":"9-70","sides":9,"height":70,"type":"攻擊","spin":"右","note":"9面高撞擊力"},
      // === 80mm 系列 ===
      {"id":"0-80","name":"0-80","sides":0,"height":80,"type":"特殊","spin":"右","note":"0面（針對特定設計）"},
      {"id":"1-80","name":"1-80","sides":1,"height":80,"type":"攻擊","spin":"右","note":"1面80mm高"},
      {"id":"2-80","name":"2-80","sides":2,"height":80,"type":"持久","spin":"右","note":"2面高"},
      {"id":"3-80","name":"3-80","sides":3,"height":80,"type":"平衡","spin":"右","note":"3面高，撞擊與持久兼備"},
      {"id":"4-80","name":"4-80","sides":4,"height":80,"type":"防禦","spin":"右","note":"4面高，良好平衡"},
      {"id":"5-80","name":"5-80","sides":5,"height":80,"type":"防禦","spin":"右","note":"5面高"},
      {"id":"6-80","name":"6-80","sides":6,"height":80,"type":"持久","spin":"右","note":"6面對稱高"},
      {"id":"7-80","name":"7-80","sides":7,"height":80,"type":"持久","spin":"右","note":"7面高"},
      {"id":"9-80","name":"9-80","sides":9,"height":80,"type":"攻擊","spin":"右","note":"9面高撞擊力"},
      // === 特殊 ===
      {"id":"4-55","name":"4-55","sides":4,"height":55,"type":"防禦","spin":"右","note":"4面55mm超低"},
      {"id":"3-85","name":"3-85","sides":3,"height":85,"type":"持久","spin":"右","note":"3面85mm超高"}
    ],
    "axes": [
      // === Standard Bits ===
      {"id":"F","name":"F","full":"Flat","type":"持久","spin":"右","note":"平面，接觸面積大"},
      {"id":"T","name":"T","full":"Taper","type":"攻擊","spin":"右","note":"錐形，穿刺力強"},
      {"id":"B","name":"B","full":"Ball","type":"持久","spin":"右","note":"球形，滾動性好"},
      {"id":"N","name":"N","full":"Needle","type":"攻擊","spin":"右","note":"針形，穿刺針"},
      {"id":"HN","name":"HN","full":"High Needle","type":"攻擊","spin":"右","note":"高針形"},
      {"id":"LF","name":"LF","full":"Low Flat","type":"防禦","spin":"右","note":"低平面，重心低"},
      {"id":"P","name":"P","full":"Point","type":"攻擊","spin":"右","note":"尖點形，穩定穿刺"},
      {"id":"O","name":"O","full":"Orb","type":"平衡","spin":"右","note":"球形，軌跡穩定"},
      {"id":"R","name":"R","full":"Rush","type":"攻擊","spin":"右","note":"衝擊形"},
      {"id":"HT","name":"HT","full":"High Taper","type":"攻擊","spin":"右","note":"高錐形"},
      {"id":"S","name":"S","full":"Spike","type":"攻擊","spin":"右","note":"尖刺形，穿刺力最高"},
      // === Special Bits ===
      {"id":"A","name":"A","full":"Accel","type":"攻擊","spin":"右","note":"加速形"},
      {"id":"DB","name":"DB","full":"Disc Ball","type":"持久","spin":"右","note":"碟形球"},
      {"id":"H","name":"H","full":"Hexa","type":"防禦","spin":"右","note":"六角形"},
      {"id":"Q","name":"Q","full":"Quake","type":"防禦","spin":"右","note":"震動形"},
      {"id":"U","name":"U","full":"Unite","type":"平衡","spin":"右","note":"合一形"},
      {"id":"C","name":"C","full":"Cyclone","type":"持久","spin":"右","note":"旋風形"},
      {"id":"D","name":"D","full":"Dot","type":"持久","spin":"右","note":"點形"},
      {"id":"G","name":"G","full":"Glide","type":"持久","spin":"右","note":"滑行形"},
      {"id":"E","name":"E","full":"Elevate","type":"持久","spin":"右","note":"上升形"},
      {"id":"FB","name":"FB","full":"Free Ball","type":"持久","spin":"右","note":"自由球形"},
      {"id":"BS","name":"BS","full":"Bound Spike","type":"攻擊","spin":"右","note":"彈性尖刺"},
      {"id":"RA","name":"RA","full":"Rubber Accel","type":"攻擊","spin":"右","note":"橡膠加速"},
      {"id":"L","name":"L","full":"Level","type":"平衡","spin":"右","note":"水平形"},
      {"id":"TP","name":"TP","full":"Trans Point","type":"攻擊","spin":"右","note":"轉移尖點"},
      {"id":"LR","name":"LR","full":"Low Rush","type":"攻擊","spin":"右","note":"低衝擊"},
      {"id":"UN","name":"UN","full":"Under Needle","type":"攻擊","spin":"右","note":"下針形"},
      {"id":"V","name":"V","full":"Vortex","type":"持久","spin":"右","note":"漩渦形"},
      {"id":"LO","name":"LO","full":"Low Orb","type":"防禦","spin":"右","note":"低球形"},
      {"id":"W","name":"W","full":"Wedge","type":"防禦","spin":"右","note":"楔形"},
      {"id":"K","name":"K","full":"Kick","type":"攻擊","spin":"右","note":"踢擊形"}
    ]
  };
  ...
  function renderParts() {
    ...
    for (var i = 0; i < PARTS_DATA.gears.length; i++) {
      ...
      html += '<div class="card" style="cursor:default"><div style="text-align:center;margin-bottom:12px">';
      html += '<img src="' + ratchetImg + '" alt="' + r.name + '" style="width:100%;max-height:100px;object-fit:contain;border-radius:8px;" onerror="this.style.display=\'none\'">';
      html += '</div><div class="card-header"><span class="card-name">' + r.name + '</span><span class="card-tier">固鎖</span></div>';
      html += '<div class="specs" style="margin-top:8px"><div class="spec"><span class="spec-label">面數</span><span class="spec-value">' + r.sides + '面</span></div><div class="spec"><span class="spec-label">高度</span><span class="spec-value">' + r.height + 'mm</span></div><div class="spec"><span class="spec-label">類型</span><span class="spec-value">' + r.type + '</span></div></div>';
      html += '<div style="font-size:0.8rem;color:#888;margin-top:8px">📌 ' + r.note + '</div></div>';
    }
    html += '</div></div>';
    html += '<div style="margin-bottom:24px">';
    html += '<div class="section-title" style="margin-top:24px">🎯 Bit（攻軸）</div><div class="grid">';
    for (var m = 0; m < PARTS_DATA.axes.length; m++) {
      var a = PARTS_DATA.axes[m];
      var bitImg = '/parts/bit_' + a.id + '.png';
      html += '<div class="card" style="cursor:default"><div style="text-align:center;margin-bottom:12px">';
      html += '<img src="' + bitImg + '" alt="' + a.name + '" style="width:100%;max-height:100px;object-fit:contain;border-radius:8px;" onerror="this.style.display=\'none\'">';
      html += '</div><div class="card-header"><span class="card-name">' + a.full + '</span><span class="card-tier">Bit</span></div>';
      html += '<div class="specs" style="margin-top:8px"><div class="spec"><span class="spec-label">簡寫</span><span class="spec-value">' + a.id + '</span></div><div class="spec"><span class="spec-label">類型</span><span class="spec-value">' + a.type + '</span></div></div>';
